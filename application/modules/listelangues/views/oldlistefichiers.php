...
<label for="">Listes des fichiers langues</label>
  <?php foreach ($fichiers as $f):?>
  
  <a  class="text-dark text-decoration-none  list-group-item border-dark " href="<?php echo base_url()?>listelangues/list_word/<?php echo $f->id_fichier;?>/1" > <?php echo $f->nom;?></a>
...
<div class="list-group col-4 m-2">
<form method='post' class="form-inline td_plus" action="<?php echo base_url();?>listelangues/td_plus?type=fichiers">
  <div class="form-group">
  <label class='form-control 'for=""><?php if (null!= $this->lang->line('ajouter')):echo $this->lang->line('ajouter');else:echo 'Ajouter';endif; ?> <?php if (null!= $this->lang->line('fichier')):echo $this->lang->line('fichier');else:echo ' un fichier';endif;?> </label>
    <input type="text" name="nom" id="" class="form-control" placeholder="" aria-describedby="helpId">
    <button class="btn btn-success" type='submit'><?php if (null!= $this->lang->line('ajouter')):echo $this->lang->line('ajouter');else:echo 'Ajouter';endif; ?>  </button>
  </div>
</form>
...
<?php 
 ...
 <form class="form-inline" action='<?php echo base_url();?>listelangues/add_lang' method='GET'>
   ...
   <form class="form-inline" action='<?php echo base_url();?>listelangues/remove_lg' method='GET'>
